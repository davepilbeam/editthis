...
my $__usage__ = qq(A simple script to automatically produce sitemaps for a webserver, in the Google Sitemap Protocol (GSP).
...
<sitemapindex
  ...
  http://www.google.com/schemas/sitemap/0.9/siteindex.xsd">\n);
